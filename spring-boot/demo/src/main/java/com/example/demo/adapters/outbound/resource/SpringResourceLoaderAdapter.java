...
/** Adapter to load resources from filesystem, classpath or web using Spring's ResourceLoader. */
public class SpringResourceLoaderAdapter implements ResourceLoaderPort {
   ...
   */
  public SpringResourceLoaderAdapter(ResourceLoader resourceLoader) {
  ...
  private LoadedResource loadFromWeb(String url) {
    try {
      ...
      if (resource.exists() && resource.isReadable()) {
        ...
        throw new ResourceNotFoundException("Web resource not found or unreadable: " + url);
      }
